    ...
    )
{
    ...
    /* Smart Card SVN: Version 10 (firmware v1.0.2)*/
    svn = LIBSPDM_SMARTCARD_SVN;
    ...
    )
{
    ...
    /* Smart Card in normal operation mode */
    ...
    /* Smart Card: no debug modes active */
    device_mode.device_mode_state = 0;
