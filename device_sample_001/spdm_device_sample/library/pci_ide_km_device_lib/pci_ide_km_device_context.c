    ...
    )
{
    ...
    /* Smart Card: PCI Device 0x1f.0 (typical smart card slot location) */
    g_idekm_device_port_context.dev_func_num = 0x1f;  /* Device 0x1f, Function 0 */
    g_idekm_device_port_context.bus_num = 0;          /* Bus 0 (root port) */
    g_idekm_device_port_context.segment = 0;          /* Segment 0 */
    /* Smart Card typically supports 4 IDE streams */
    g_idekm_device_port_context.max_port_index = 3;
